...
class SaturdayActivity : AppCompatActivity() {
    ...
    private var goodChartTotalSaturday:Float = 100.00f
...
//chart analisys button
    ...
    fun calculatePercentageTotalChart(){
        goodChartTotalSaturday = 100.00f

        if (hoursSleep < 5 || hoursSleep > 11){
            goodChartTotalSaturday = goodChartTotalSaturday- 14.00f
        } else if(hoursSleep < 7 || hoursSleep > 9){
            goodChartTotalSaturday = goodChartTotalSaturday - 5.00f
        }
        if (heartRateAverage > 65.00f){
            goodChartTotalSaturday = goodChartTotalSaturday - 20.00f
        } else if (heartRateAverage < 40.00f || heartRateAverage > 50.50f){
            goodChartTotalSaturday = goodChartTotalSaturday - 12.00f
        }
        if (Averagebreath > 27){
            goodChartTotalSaturday = goodChartTotalSaturday - 18.00f
        } else if (Averagebreath < 12 || Averagebreath > 20){
            goodChartTotalSaturday = goodChartTotalSaturday - 10.00f
        }
        if (awakening > 3){
            goodChartTotalSaturday = goodChartTotalSaturday - 10.00f
        } else if (awakening > 0){
            goodChartTotalSaturday = goodChartTotalSaturday - 4.00f
        }
        if (noise > 0){
            goodChartTotalSaturday = goodChartTotalSaturday - 3.00f
        }
        if (hoursSleep == 0 && heartRateAverage == 0.00f && Averagebreath == 0 && awakening == 0 && noise == 0){
            goodChartTotalSaturday = 0.00f
        }

        val sharedPreferencesSaturday = getSharedPreferences("MyPrefsSaturday", Context.MODE_PRIVATE)
        sharedPreferencesSaturday.edit()
            .putFloat("goodChartTotalSaturday", goodChartTotalSaturday)
            .apply()
    }
    ...
    fun buttonChange()
    {
        ...
        chartButton.setOnClickListener {
            val pageChart = Intent(this, SaturdayChartActivity::class.java)
