...
class WednesdayActivity : AppCompatActivity() {
    var hoursSleep:Int = 12  //7-9 --> 6/10
    var minutesSleep:Int = 23
    var minutesRest:Int = 0
    var hoursRest:Int = 2
    var heartRateAverage:Float = 43.00f //40-50.50 --> 50.51/60
    var awakening:Int = 0 //0 --> 1/3
    var Averagebreath:Int = 13   //12-20 --> 10/24
    var noise:Int = 0  //0
    var totalHours:Int = hoursSleep + hoursRest
    var totalMinutes:Int = minutesSleep + minutesRest
    private var goodChartTotalWednesday:Float = 100.00f
    ...
    fun calculatePercentageTotalChart(){
        goodChartTotalWednesday = 100.00f

        if (hoursSleep < 5 || hoursSleep > 11){
            goodChartTotalWednesday = goodChartTotalWednesday - 14.00f
        } else if(hoursSleep < 7 || hoursSleep > 9){
            goodChartTotalWednesday = goodChartTotalWednesday - 5.00f
        }
        if (heartRateAverage > 65.00f){
            goodChartTotalWednesday = goodChartTotalWednesday - 20.00f
        } else if (heartRateAverage < 40.00f || heartRateAverage > 50.50f){
            goodChartTotalWednesday = goodChartTotalWednesday - 12.00f
        }
        if (Averagebreath > 27){
            goodChartTotalWednesday = goodChartTotalWednesday - 18.00f
        } else if (Averagebreath < 12 || Averagebreath > 20){
            goodChartTotalWednesday = goodChartTotalWednesday - 10.00f
        }
        if (awakening > 3){
            goodChartTotalWednesday = goodChartTotalWednesday - 10.00f
        } else if (awakening > 0){
            goodChartTotalWednesday= goodChartTotalWednesday - 4.00f
        }
        if (noise > 0){
            goodChartTotalWednesday = goodChartTotalWednesday - 3.00f
        }
        if (hoursSleep == 0 && heartRateAverage == 0.00f && Averagebreath == 0 && awakening == 0 && noise == 0){
            goodChartTotalWednesday = 0.00f
        }

        val sharedPreferencesWednesday = getSharedPreferences("MyPrefsWednesday", Context.MODE_PRIVATE)
        sharedPreferencesWednesday.edit()
            .putFloat("goodChartTotalWednesday", goodChartTotalWednesday)
            .apply()
    }
    ...
    fun buttonChange()
    {
        ...
        chartButton.setOnClickListener {
            val pageChart = Intent(this, WednesdayChartActivity::class.java)
        ...
        thursdayButton.setOnClickListener {
            val pageThursday = Intent(this, ThursdayActivity::class.java)
            startActivity(pageThursday)
        }
