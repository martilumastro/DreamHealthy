...
class FridayAlarmClockActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_friday_alarm_clock)
            ...
            if (currentText == "--:--") {
                ...
                val timePickerDialog = TimePickerDialog(
                    ...
                    { _, selectedHour, selectedMinute ->
                        ...
                        //save data
                        val prefsFriday = getSharedPreferences("alarms", MODE_PRIVATE).edit()
                        prefsFriday.putBoolean("friday_alarm_set", true)
                        prefsFriday.putString("friday_alarm_time", String.format("%02d:%02d", selectedHour, selectedMinute))
                        prefsFriday.putString("friday_sleep_hour", String.format("%02d:%02d", sleepHour, sleepMinute))
                        prefsFriday.putString("friday_alarm_melody", alarmMelodyTextView.text.toString())
                        prefsFriday.putString("friday_sleep_melody", sleepMelodyTextView.text.toString())
                        prefsFriday.putString("friday_wake_melody", wakeUpMelodyTextView.text.toString())
                        prefsFriday.apply()
                    },
                    hour,
                    minute,
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Delete") { _, _ ->
                        ...
                        val prefsFridayDelete = getSharedPreferences("alarms", MODE_PRIVATE)
                        prefsFridayDelete.edit()
    ...
    private fun setAlarm(hour: Int, minute: Int) {
        ...
        val calendar = Calendar.getInstance().apply {
            ...
            //Next Friday if today is not Friday
            while (get(Calendar.DAY_OF_WEEK) != Calendar.FRIDAY) {
                add(Calendar.DATE, 1)
            }
            //Next Friday if today is Friday and time is before current time
        ...
        MelodyStorageManager.saveMelody(this, "Friday", "alarm", "music_alarm_melody1.mp3")
        //read name of the melody
        val melodyPath = MelodyStorageManager.getMelody(this, "Friday", "alarm")
        ...
        val showIntent = Intent(this, FridayAlarmClockActivity::class.java)
        ...
        prefsFriday.edit()
            ...
            .putBoolean("friday_alarm_set", true)
            .putString("friday_alarm_time", String.format("%02d:%02d", hour, minute))
            .apply()
    }
    // fun sleep melody
    ...
    fun viewThisDay() {
        ...
        val nextFriday = today.with(java.time.temporal.TemporalAdjusters.next(DayOfWeek.FRIDAY))
        //formatted
        val formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy")
        val formattedDate = nextFriday.format(formatter)
    ...
    override fun onResume() {
        ...
        val isAlarmSet = prefsFriday.getBoolean("friday_alarm_set", false)
        //if the alarm has been set, read the time
        if (isAlarmSet) {
            wakeUpHourTextView.text = prefsFriday.getString("friday_alarm_time", "--:--")
            sleepUpHourTextView.text = prefsFriday.getString("friday_sleep_hour", "--:--")
            //and the text for the melody
            alarmMelodyTextView.text = MelodyStorageManager.getMelody(this, "Friday", "alarm") ?: ""
            sleepMelodyTextView.text = MelodyStorageManager.getMelody(this, "Friday", "sleep") ?: ""
            wakeUpMelodyTextView.text = MelodyStorageManager.getMelody(this, "Friday", "wake") ?: ""
        } else {
