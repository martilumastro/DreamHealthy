...
class ToDoUsefulAdvinceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_to_do_useful_advince)
    ...
    fun changePage(){
        ...
        buttonBack.setOnClickListener {
            val backPage = Intent(this, FoodUsefulAdvinceActivity::class.java)
            startActivity(backPage)
        }
        buttonNext.setOnClickListener {
            val nextPage = Intent(this, MorningUsefulAdvinceActivity::class.java)
    ...
    fun listUsefulAdvince(){
        ...
        list = arrayOf(
            ...
            "Don’t use your bed for work or studying.",
