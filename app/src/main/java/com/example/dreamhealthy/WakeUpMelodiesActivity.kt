...
class WakeUpMelodiesActivity : AppCompatActivity() {
    ...
    private val melodies = listOf(
        Melody("background_melody_relax_wake.mp3", R.drawable.icon_wake_up),
        Melody("guitar_relax_melody_wake.mp3", R.drawable.img_wake_up_loto),
        Melody("japanese_gong_melody_wake.mp3", R.drawable.img_meditazione_heart),
        Melody("zen_gong_melody_wake.mp3", R.drawable.img_simbol_zen),
        Melody("piano_melody_wake.mp3", R.drawable.img_heart),
        Melody("wind_zen_melody_wake.mp3", R.drawable.img_sun_wake_up),
    )
    ...
    private fun imageViewMelodies() {
        ...
        imageMelodies = listOf(
            ...
            findViewById(R.id.img_meditazione_heart),
            findViewById(R.id.img_simbol),
            findViewById(R.id.img_heart),
