...
class SleepForestActivity : AppCompatActivity() {
    //var
    ...
    private val melodies = listOf(
        Melody("gentle_rain.mp3", R.drawable.img_forest_white),
        Melody("rain_and_thunder.mp3", R.drawable.img_thunder1),
        Melody("river_water_calm.mp3", R.drawable.img_river_white),
        Melody("cicadas_in_the_night.mp3", R.drawable.img_rain_white),
        Melody("rain_and_thunder_2.mp3", R.drawable.img_thunder2),
        Melody("rainy_windows_dreams.mp3", R.drawable.img_night_rain_white),
    )

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_sleep_forest)
    ...
    private fun imageViewMelodies() {
        ...
        imageMelodies = listOf(
            findViewById(R.id.img_melody_forest),
            findViewById(R.id.img_strong_thunder),
            findViewById(R.id.img_melody_river),
            findViewById(R.id.img_melody_rain),
            findViewById(R.id.img_thunder_light),
