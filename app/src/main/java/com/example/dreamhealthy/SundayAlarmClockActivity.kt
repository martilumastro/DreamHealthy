...
class SundayAlarmClockActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        if (isAlarmSet) {
            ...
            alarmMelodyTextView.text = prefsSunday.getString("sunday_alarm_melody", "")
            sleepMelodyTextView.text = prefsSunday.getString("sunday_sleep_melody", "")
            wakeUpMelodyTextView.text = prefsSunday.getString("sunday_wake_melody", "")
        } else {
