...
class SundayAlarmClockActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_sunday_alarm_clock)
            ...
            if (currentText == "--:--") {
                ...
                val timePickerDialog = TimePickerDialog(
                    ...
                    { _, selectedHour, selectedMinute ->
                        ...
                        //save data
                        val prefsSunday = getSharedPreferences("alarms", MODE_PRIVATE).edit()
                        prefsSunday.putBoolean("sunday_alarm_set", true)
                        prefsSunday.putString("sunday_alarm_time", String.format("%02d:%02d", selectedHour, selectedMinute))
                        prefsSunday.putString("sunday_sleep_hour", String.format("%02d:%02d", sleepHour, sleepMinute))
                        prefsSunday.putString("sunday_alarm_melody", alarmMelodyTextView.text.toString())
                        prefsSunday.putString("sunday_sleep_melody", sleepMelodyTextView.text.toString())
                        prefsSunday.putString("sunday_wake_melody", wakeUpMelodyTextView.text.toString())
                        prefsSunday.apply()
                    },
                    hour,
                    minute,
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Delete") { _, _ ->
                        ...
                        val prefsSundayDelete = getSharedPreferences("alarms", MODE_PRIVATE)
                        prefsSundayDelete.edit()
    ...
    private fun setAlarm(hour: Int, minute: Int) {
        ...
        val calendar = Calendar.getInstance().apply {
            ...
            //Next sunday if today is not sunday
            while (get(Calendar.DAY_OF_WEEK) != Calendar.SUNDAY) {
                add(Calendar.DATE, 1)
            }
            //Next sunday if today is sunday and time is before current time
        ...
        MelodyStorageManager.saveMelody(this, "Sunday", "alarm", "music_alarm_melody1.mp3")
        //read name of the melody
        val melodyPath = MelodyStorageManager.getMelody(this, "Sunday", "alarm")
        ...
        val showIntent = Intent(this, SundayAlarmClockActivity::class.java)
        ...
        prefsSunday.edit()
            .putBoolean("sunday_alarm_set", true)
            .putString("sunday_alarm_time", String.format("%02d:%02d", hour, minute))
            .apply()
    }
    // fun sleep melody
    private fun setSleepMelody(hour: Int, minute: Int) {
        ...
        MelodyStorageManager.saveMelody(this, "Friday", "sleep", "zen_relax_melody.mp3")
        //read the saved melody
        val melodyPath = MelodyStorageManager.getMelody(this, "Friday", "sleep")
        //standard if null
    ...
    private fun setPreWakeMelody(wakeHour: Int, wakeMinute: Int) {
        ...
        MelodyStorageManager.saveMelody(this, "Sunday", "wake", "guitar_relax_melody_wake.mp3")
        //read the saved melody
        val melodyPath = MelodyStorageManager.getMelody(this, "Sunday", "wake")
        //if melody is null
    ...
    fun viewThisDay() {
        ...
        val nextSunday = today.with(java.time.temporal.TemporalAdjusters.next(DayOfWeek.SUNDAY))

        val formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy")
        val formattedDate = nextSunday.format(formatter)
    ...
    override fun onResume() {
        ...
        val isAlarmSet = prefsSunday.getBoolean("sunday_alarm_set", false)
        //if the alarm has been set, read the time
        if (isAlarmSet) {
            wakeUpHourTextView.text = prefsSunday.getString("sunday_alarm_time", "--:--")
            sleepUpHourTextView.text = prefsSunday.getString("sunday_sleep_hour", "--:--")
            //and the text for the melody
            alarmMelodyTextView.text = MelodyStorageManager.getMelody(this, "Sunday", "alarm") ?: ""
            sleepMelodyTextView.text = MelodyStorageManager.getMelody(this, "Sunday", "sleep") ?: ""
            wakeUpMelodyTextView.text = MelodyStorageManager.getMelody(this, "Sunday", "wake") ?: ""
        } else {
