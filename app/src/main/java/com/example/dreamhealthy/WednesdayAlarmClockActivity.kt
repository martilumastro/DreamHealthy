...
class WednesdayAlarmClockActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_wednesday_alarm_clock)
            ...
            if (currentText == "--:--") {
                ...
                val timePickerDialog = TimePickerDialog(
                    ...
                    { _, selectedHour, selectedMinute ->
                        ...
                        //save data
                        val prefsWednesday = getSharedPreferences("alarms", MODE_PRIVATE).edit()
                        prefsWednesday.putBoolean("wednesday_alarm_set", true)
                        prefsWednesday.putString("wednesday_alarm_time", String.format("%02d:%02d", selectedHour, selectedMinute))
                        prefsWednesday.putString("wednesday_sleep_hour", String.format("%02d:%02d", sleepHour, sleepMinute))
                        prefsWednesday.putString("wednesday_alarm_melody", alarmMelodyTextView.text.toString())
                        prefsWednesday.putString("wednesday_sleep_melody", sleepMelodyTextView.text.toString())
                        prefsWednesday.putString("wednesday_wake_melody", wakeUpMelodyTextView.text.toString())
                        prefsWednesday.apply()
                    },
                    hour,
                    minute,
                    true
                ...
                AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Delete") { _, _ ->
                        ...
                        val prefsWednesdayDelete = getSharedPreferences("alarms", MODE_PRIVATE)
                        prefsWednesdayDelete.edit()
    ...
    private fun setAlarm(hour: Int, minute: Int) {
        ...
        val calendar = Calendar.getInstance().apply {
            ...
            //Next Wednesday if today is not Wednesday
            while (get(Calendar.DAY_OF_WEEK) != Calendar.WEDNESDAY) {
                add(Calendar.DATE, 1)
            }
            //Next Wednesday if today is Wednesday and time is before current time
        ...
        MelodyStorageManager.saveMelody(this, "Wednesday", "alarm", "music_alarm_melody1.mp3")
        //read name of the melody
        val melodyPath = MelodyStorageManager.getMelody(this, "Wednesday", "alarm")
        ...
        val showIntent = Intent(this, WednesdayAlarmClockActivity::class.java)
        ...
        prefsWednesday.edit()
            .putBoolean("wednesday_alarm_set", true)
            .putString("wednesday_alarm_time", String.format("%02d:%02d", hour, minute))
            .apply()
    }
    // fun sleep melody
    private fun setSleepMelody(hour: Int, minute: Int) {
        ...
        MelodyStorageManager.saveMelody(this, "Wednesday", "sleep", "zen_relax_melody.mp3")
        //read the saved melody
        val melodyPath = MelodyStorageManager.getMelody(this, "Wednesday", "sleep")
        //standard if null
    ...
    private fun setPreWakeMelody(wakeHour: Int, wakeMinute: Int) {
        ...
        MelodyStorageManager.saveMelody(this, "Wednesday", "wake", "guitar_relax_melody_wake.mp3")
        //read the saved melody
        val melodyPath = MelodyStorageManager.getMelody(this, "Wednesday", "wake")
        //if melody is null
    ...
    fun viewThisDay() {
        ...
        val nextWednesday = today.with(java.time.temporal.TemporalAdjusters.next(DayOfWeek.WEDNESDAY))

        val formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy")
        val formattedDate = nextWednesday.format(formatter)
    ...
    override fun onResume() {
        ...
        val isAlarmSet = prefsWednesday.getBoolean("wednesday_alarm_set", false)
        //if the alarm has been set, read the time
        if (isAlarmSet) {
            wakeUpHourTextView.text = prefsWednesday.getString("wednesday_alarm_time", "--:--")
            sleepUpHourTextView.text = prefsWednesday.getString("wednesday_sleep_hour", "--:--")
            //and the text for the melody
            alarmMelodyTextView.text = MelodyStorageManager.getMelody(this, "Wednesday", "alarm") ?: ""
            sleepMelodyTextView.text = MelodyStorageManager.getMelody(this, "Wednesday", "sleep") ?: ""
            wakeUpMelodyTextView.text = MelodyStorageManager.getMelody(this, "Wednesday", "wake") ?: ""
        } else {
