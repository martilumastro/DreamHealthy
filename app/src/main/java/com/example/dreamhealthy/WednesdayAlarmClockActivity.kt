...
class WednesdayAlarmClockActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        if (isAlarmSet) {
            ...
            alarmMelodyTextView.text = prefsWednesday.getString("wednesday_alarm_melody", "")
            sleepMelodyTextView.text = prefsWednesday.getString("wednesday_sleep_melody", "")
            wakeUpMelodyTextView.text = prefsWednesday.getString("wednesday_wake_melody", "")
        } else {
